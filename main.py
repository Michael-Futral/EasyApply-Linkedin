...
class EasyApplyLinkedin:
    ...
    def job_search(self):
        ...
        # jobs_link = self.driver.find_element(
        #     "css_selector",
        #     ".app-aware-link global-nav__primary-link--active global-nav__primary-link[aria-current='page']"
        # )
        jobs_link.click()
    ...
    def filter(self):
        ...
        all_filters_button = self.driver.find_element(
            "xpath", "//button[@data-control-name='all_filters']")
        all_filters_button.click()
        time.sleep(1)
        easy_apply_button = self.driver.find_element(
            "xpath", "//label[@for='f_LF-f_AL']")
        easy_apply_button.click()
        time.sleep(1)
        apply_filter_button = self.driver.find_element(
            "xpath", "//button[@data-control-name='all_filters_apply']")
    ...
    def find_offers(self):
        ...
        total_results = self.driver.find_element(
            "class_name", "display-flex.t-12.t-black--light.t-normal")
    ...
    def submit_apply(self, job_add):
        ...
        try:
            submit = self.driver.find_element(
                "xpath", "//button[@data-control-name='submit_unify']")
        ...
        # ... if not available, discard application and go to next
            ...
            try:
                ...
                discard_confirm = self.driver.find_element(
                    "xpath", "//button[@data-test-dialog-primary-btn]")
